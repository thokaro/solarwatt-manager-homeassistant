...
NORMALIZATION_RULES: list[tuple[str, str]] = [
    ...
    (r"^solarwattBattery_batteryflex_BatteryFlex_[^_]+_harmonized_", "batteryflex_"),
    (r"^solarwattBattery_batteryflex_BatteryFlex_[^_]+_batteryChannelGroup_", "batteryflex_"),
    (r"^solarwattBattery_batteryflex_BatteryFlex_[^_]+_", "batteryflex_"),
